...
class FW<K, V> extends Node<K, V> implements NodeFactory<K, V> {
   ...
   public final Object getKeyReference() {
      References.WeakValueReference var1 = (References.WeakValueReference)VALUE.getAcquire((FW)this);
   ...
   public final V getValue() {
      Reference var1 = (Reference)VALUE.getAcquire((FW)this);
      ...
      while (true) {
         ...
         Reference var3 = (Reference)VALUE.getAcquire((FW)this);
         if (var1 == var3) {
            return null;
         }
   ...
   public final Object getValueReference() {
      return (Object)VALUE.getAcquire((FW)this);
   }
   ...
   public final void retire() {
      References.WeakValueReference var1 = (References.WeakValueReference)VALUE.getOpaque((FW)this);
      Reference var2 = (Reference)var1.getKeyReference();
      var2.clear();
