...
public class OrNode extends BinaryNode {
   ...
   public void applyOperand(MethodVisitor visitor, String generatedImplementationName) {
      ...
      visitor.visitJumpInsn(154, shortcut);
   ...
   public BinaryNode.Op getOp() {
      return BinaryNode.Op.OR;
   }

   @Override
   public Node constantSimplify() {
      return Constant.of(((Constant)this.left).getValue() == 0.0 && ((Constant)this.right).getValue() == 0.0 ? 0.0 : 1.0);
   }

   @Override
   public double eval(double[] localVariables, double... inputs) {
      return this.left.eval(localVariables, inputs) == 0.0 && this.right.eval(localVariables, inputs) == 0.0 ? 0.0 : 1.0;
   }
}
