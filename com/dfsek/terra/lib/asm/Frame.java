...
class Frame {
   ...
   final void accept(MethodWriter methodWriter) {
      ...
      while (numLocal-- > 0) {
         int localType = localTypes[var11];
         var11 += localType != 4194308 && localType != 4194307 ? 1 : 2;
      ...
      while (numStack-- > 0) {
         int stackType = stackTypes[var11];
         var11 += stackType != 4194308 && stackType != 4194307 ? 1 : 2;
