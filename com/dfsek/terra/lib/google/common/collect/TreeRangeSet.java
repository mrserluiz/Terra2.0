...
public class TreeRangeSet<C extends Comparable<?>> extends AbstractRangeSet<C> implements Serializable {
   ...
   public RangeSet<C> subRangeSet(Range<C> view) {
      return view.equals(Range.all()) ? this : new TreeRangeSet.SubRangeSet(view);
   }
   ...
   static final class RangesByUpperBound<C extends Comparable<?>> extends AbstractNavigableMap<Cut<C>, Range<C>> {
      ...
      private NavigableMap<Cut<C>, Range<C>> subMap(Range<Cut<C>> window) {
         return window.isConnected(this.upperBoundWindow)
   ...
   private final class SubRangeSet extends TreeRangeSet<C> {
      ...
      public RangeSet<C> subRangeSet(Range<C> view) {
         if (view.encloses(this.restriction)) {
            ...
            return view.isConnected(this.restriction) ? new TreeRangeSet.SubRangeSet(this.restriction.intersection(view)) : ImmutableRangeSet.of();
         }
      }
   }
   ...
   private static final class SubRangeSetRangesByLowerBound<C extends Comparable<?>> extends AbstractNavigableMap<Cut<C>, Range<C>> {
      ...
      private NavigableMap<Cut<C>, Range<C>> subMap(Range<Cut<C>> window) {
         return !window.isConnected(this.lowerBoundWindow)
            ? ImmutableSortedMap.of()
