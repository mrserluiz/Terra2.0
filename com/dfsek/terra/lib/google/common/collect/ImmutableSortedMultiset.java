...
public abstract class ImmutableSortedMultiset<E> extends ImmutableMultiset<E> implements SortedMultiset<E> {
   @LazyInit
   transient @Nullable ImmutableSortedMultiset<E> descendingMultiset;
   @J2ktIncompatible
   ...
   public static <E extends Comparable<? super E>> ImmutableSortedMultiset<E> of(E e1) {
      RegularImmutableSortedSet<E> elementSet = (RegularImmutableSortedSet<E>)ImmutableSortedSet.<E>of(e1);
   ...
   public ImmutableSortedMultiset<E> descendingMultiset() {
      ...
      return result == null
         ? (
            this.descendingMultiset = this.isEmpty()
   ...
   @Override
   public final Multiset.@Nullable Entry<E> pollFirstEntry() {
   ...
   @DoNotCall("Always throws UnsupportedOperationException")
   @Override
   public final Multiset.@Nullable Entry<E> pollLastEntry() {
      throw new UnsupportedOperationException();
   }
