...
public abstract class MultimapBuilder<K0, V0> {
   ...
   public static MultimapBuilder.MultimapBuilderWithKeys<@Nullable Object> hashKeys() {
      return hashKeys(8);
   }

   public static MultimapBuilder.MultimapBuilderWithKeys<@Nullable Object> hashKeys(int expectedKeys) {
   ...
   public static MultimapBuilder.MultimapBuilderWithKeys<@Nullable Object> linkedHashKeys() {
      return linkedHashKeys(8);
   }

   public static MultimapBuilder.MultimapBuilderWithKeys<@Nullable Object> linkedHashKeys(int expectedKeys) {
      CollectPreconditions.checkNonnegative(expectedKeys, "expectedKeys");
      return new MultimapBuilder.MultimapBuilderWithKeys<Object>() {
         @Override
         <K, V> Map<K, Collection<V>> createMap() {
