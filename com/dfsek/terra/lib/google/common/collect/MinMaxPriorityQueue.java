...
public final class MinMaxPriorityQueue<E> extends AbstractQueue<E> {
   ...
   @VisibleForTesting
   @CanIgnoreReturnValue
   MinMaxPriorityQueue.@Nullable MoveDesc<E> removeAt(int index) {
   ...
   private MinMaxPriorityQueue.@Nullable MoveDesc<E> fillHole(int index, E toTrickle) {
   ...
   class Heap {
      ...
      MinMaxPriorityQueue.@Nullable MoveDesc<E> tryCrossOverAndBubbleUp(int removeIndex, int vacated, E toTrickle) {
