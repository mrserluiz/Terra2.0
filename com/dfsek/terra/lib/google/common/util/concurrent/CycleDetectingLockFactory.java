...
public class CycleDetectingLockFactory {
   ...
   private static <E extends Enum<E>> Map<? extends E, CycleDetectingLockFactory.LockGraphNode> getOrCreateNodes(Class<E> clazz) {
      Map<E, CycleDetectingLockFactory.LockGraphNode> existing = (Map<E, CycleDetectingLockFactory.LockGraphNode>)lockGraphNodesPerType.get(clazz);
      if (existing != null) {
         return existing;
      }

      Map<E, CycleDetectingLockFactory.LockGraphNode> created = createNodes(clazz);
      existing = (Map<E, CycleDetectingLockFactory.LockGraphNode>)lockGraphNodesPerType.putIfAbsent(clazz, created);
   ...
   private void aboutToAcquire(CycleDetectingLockFactory.CycleDetectingLock lock) {
      if (!lock.isAcquiredByCurrentThread()) {
         ArrayList<CycleDetectingLockFactory.LockGraphNode> acquiredLockList = Objects.requireNonNull(acquiredLocks.get());
   ...
   private static class LockGraphNode {
      ...
      void checkAcquiredLocks(CycleDetectingLockFactory.Policy policy, List<CycleDetectingLockFactory.LockGraphNode> acquiredLocks) {
         for (CycleDetectingLockFactory.LockGraphNode acquiredLock : acquiredLocks) {
      ...
      private CycleDetectingLockFactory.@Nullable ExampleStackTrace findPathTo(
   ...
   public enum Policies implements CycleDetectingLockFactory.Policy {
      THROW {
         @Override
   ...
   public static final class WithExplicitOrdering<E extends Enum<E>> extends CycleDetectingLockFactory {
      ...
      public ReentrantLock newReentrantLock(E rank, boolean fair) {
         return this.policy == CycleDetectingLockFactory.Policies.DISABLED
            ? new ReentrantLock(fair)
            : new CycleDetectingLockFactory.CycleDetectingReentrantLock(Objects.requireNonNull(this.lockGraphNodes.get(rank)), fair);
      }
      ...
      public ReentrantReadWriteLock newReentrantReadWriteLock(E rank, boolean fair) {
         return this.policy == CycleDetectingLockFactory.Policies.DISABLED
            ? new ReentrantReadWriteLock(fair)
            : new CycleDetectingLockFactory.CycleDetectingReentrantReadWriteLock(Objects.requireNonNull(this.lockGraphNodes.get(rank)), fair);
      }
   }
}
