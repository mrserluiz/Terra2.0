...
import com.dfsek.terra.lib.google.common.hash.Hashing;
import com.dfsek.terra.lib.google.common.io.ByteStreams;
...
public final class InetAddresses {
   ...
   public static InetAddress forString(String ipString) {
      InetAddresses.Scope scope = new InetAddresses.Scope();
   ...
   private static byte @Nullable [] ipStringToBytes(String ipStringParam, InetAddresses.@Nullable Scope scope) {
   ...
   private static @Nullable InetAddress forUriStringOrNull(String hostAddr, boolean parseScope) {
      ...
      InetAddresses.Scope scope = parseScope ? new InetAddresses.Scope() : null;
      byte[] addr = ipStringToBytes(ipString, scope);
