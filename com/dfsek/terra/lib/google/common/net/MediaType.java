...
import com.dfsek.terra.lib.google.common.collect.ImmutableListMultimap;
import com.dfsek.terra.lib.google.common.collect.ImmutableMultiset;
...
public final class MediaType {
   ...
   private static final ImmutableListMultimap<String, String> UTF_8_CONSTANT_PARAMETERS = ImmutableListMultimap.of(
      "charset", Ascii.toLowerCase(StandardCharsets.UTF_8.name())
   );
   ...
   public static final MediaType CBOR = createConstant("application", "cbor");
   ...
   private static MediaType create(String type, String subtype, Multimap<String, String> parameters) {
      ...
      Preconditions.checkArgument(!normalizedType.equals("*") || normalizedSubtype.equals("*"), "A wildcard type cannot be used with a non-wildcard subtype");
      ImmutableListMultimap.Builder<String, String> builder = ImmutableListMultimap.builder();
   ...
   private static String normalizeParameterValue(String attribute, String value) {
      ...
      return attribute.equals("charset") ? Ascii.toLowerCase(value) : value;
   }
   ...
   private static void consumeSeparator(MediaType.Tokenizer tokenizer, char c) {
   ...
   public int hashCode() {
      int h = this.hashCode;
      if (h == 0) {
         h = Objects.hash(this.type, this.subtype, this.parametersAsMap());
         this.hashCode = h;
      }
   ...
   private String computeToString() {
      ...
      if (!this.parameters.isEmpty()) {
         builder.append("; ");
         Multimap<String, String> quotedParameters = Multimaps.transformValues(
            this.parameters, value -> TOKEN_MATCHER.matchesAllOf(value) && !value.isEmpty() ? value : escapeAndQuote(value)
         );
