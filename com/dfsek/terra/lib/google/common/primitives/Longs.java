...
public final class Longs {
   ...
   public static List<Long> asList(long... backingArray) {
      return backingArray.length == 0 ? Collections.emptyList() : new Longs.LongArrayAsList(backingArray);
   }
   ...
   private static class LongArrayAsList extends AbstractList<Long> implements RandomAccess, Serializable {
      ...
      public List<Long> subList(int fromIndex, int toIndex) {
         ...
         return fromIndex == toIndex ? Collections.emptyList() : new Longs.LongArrayAsList(this.array, this.start + fromIndex, this.start + toIndex);
      }
   ...
   private static final class LongConverter extends Converter<String, Long> implements Serializable {
      static final Converter<String, Long> INSTANCE = new Longs.LongConverter();
      @GwtIncompatible
      @J2ktIncompatible
