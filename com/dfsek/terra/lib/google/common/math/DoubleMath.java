...
public final class DoubleMath {
   ...
   public static int roundToInt(double x, RoundingMode mode) {
      ...
      MathPreconditions.checkInRangeForRoundingInputs(z > -2.147483649E9 & z < 2.1474836E9F, x, mode);
      return (int)z;
   }
   ...
   public static long roundToLong(double x, RoundingMode mode) {
      double z = roundIntermediate(x, mode);
      MathPreconditions.checkInRangeForRoundingInputs(-9.223372E18F - z < 1.0 & z < 9.223372E18F, x, mode);
      return (long)z;
   }
