...
final class StandardMutableNetwork<N, E> extends StandardNetwork<N, E> implements MutableNetwork<N, E> {
   ...
   public boolean removeEdge(E edge) {
      ...
      NetworkConnections<N, E> connectionsU = Objects.requireNonNull(this.nodeConnections.get(nodeU));
      N nodeV = connectionsU.adjacentNode(edge);
      NetworkConnections<N, E> connectionsV = Objects.requireNonNull(this.nodeConnections.get(nodeV));
