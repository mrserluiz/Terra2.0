...
final class Crc32cHashFunction extends AbstractHashFunction {
   ...
   static final class Crc32cHasher extends AbstractStreamingHasher {
      ...
      private int crc2 = 0;
      private int crc3 = 0;
      static final int[] byteTable = new int[]{
         0,
         -227835133,
         -516198153,
         324072436,
      ...
      static final int[][] strideTable = new int[][]{
         {
               0,
               819083365,
               1638166730,
      ...
      protected void process(ByteBuffer bb) {
         ...
         while (bb.remaining() >= 16) {
            ...
            this.crc0 = this.crc0 ^ bb.getInt();
            this.crc1 = this.crc1 ^ bb.getInt();
            this.crc2 = this.crc2 ^ bb.getInt();
            this.crc3 = this.crc3 ^ bb.getInt();
         }
      }
      ...
      protected void processRemaining(ByteBuffer bb) {
         if (!this.finished) {
            this.crc0 = combine(0, this.crc0);
            this.crc0 = combine(this.crc0, this.crc1);
            this.crc0 = combine(this.crc0, this.crc2);
            this.crc0 = combine(this.crc0, this.crc3);

            while (bb.hasRemaining()) {
               this.crc0 = this.crc0 >>> 8 ^ byteTable[(bb.get() ^ this.crc0) & 0xFF];
            }
      ...
      static int computeForWord(int word) {
         return strideTable[3][word & 0xFF] ^ strideTable[2][word >>> 8 & 0xFF] ^ strideTable[1][word >>> 16 & 0xFF] ^ strideTable[0][word >>> 24];
      }
