...
final class FarmHashFingerprint64 extends AbstractNonStreamingHashFunction {
   ...
   private static long hashLength65Plus(byte[] bytes, int offset, int length) {
      ...
      do {
         ...
         long var22 = Long.rotateRight(y + v[1] + LittleEndianByteArray.load64(bytes, offset + 48), 42) * -5435081209227447693L;
         x ^= w[1];
         y = var22 + v[0] + LittleEndianByteArray.load64(bytes, offset + 40);
