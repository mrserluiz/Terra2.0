...
public class Validate {
   ...
   public static void isAssignableFrom(Class<?> superType, Class<?> type) {
      if (type == null || superType == null || !superType.isAssignableFrom(type)) {
         throw new IllegalArgumentException(
            String.format("Cannot assign a %s to a %s", ClassUtils.getName(type, "null type"), ClassUtils.getName(superType, "null type"))
         );
      }
   }
   ...
   public static <T> T[] noNullElements(T[] array, String message, Object... values) {
      Objects.requireNonNull((T)array, "array");
   ...
   public static <T> T[] notEmpty(T[] array, String message, Object... values) {
      Objects.requireNonNull((T)array, toSupplier(message, values));
      if (array.length == 0) {
         throw new IllegalArgumentException(getMessage(message, values));
      } else {
         return array;
