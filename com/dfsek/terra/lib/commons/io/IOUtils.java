...
import com.dfsek.terra.lib.commons.io.function.IOTriFunction;
...
import com.dfsek.terra.lib.commons.io.output.AppendableWriter;
import com.dfsek.terra.lib.commons.io.output.NullOutputStream;
import com.dfsek.terra.lib.commons.io.output.NullWriter;
import com.dfsek.terra.lib.commons.io.output.StringBuilderWriter;
import com.dfsek.terra.lib.commons.io.output.ThresholdingOutputStream;
import com.dfsek.terra.lib.commons.io.output.UnsynchronizedByteArrayOutputStream;
...
public class IOUtils {
   ...
   public static boolean contentEquals(InputStream input1, InputStream input2) throws IOException {
      if (input1 == input2) {
         ...
         return input1 != null && input2 != null ? FileChannels.contentEquals(Channels.newChannel(input1), Channels.newChannel(input2), 8192) : false;
      }
   }
   ...
   public static long copy(URL url, File file) throws IOException {
      OutputStream outputStream = Files.newOutputStream(Objects.requireNonNull(file, "file").toPath());
   ...
   public static long copy(URL url, OutputStream outputStream) throws IOException {
      InputStream inputStream = Objects.requireNonNull(url, "url").openStream();
   ...
   public static int read(InputStream input, byte[] buffer, int offset, int length) throws IOException {
      return length == 0 ? 0 : read(input::read, buffer, offset, length);
   }
   ...
   static int read(IOTriFunction<byte[], Integer, Integer, Integer> input, byte[] buffer, int offset, int length) throws IOException {
      ...
      while (remaining > 0) {
         ...
         int count = input.apply(buffer, offset + location, remaining);
         if (-1 == count) {
            break;
         }
   ...
   public static long skip(ReadableByteChannel input, long toSkip) throws IOException {
      ...
      while (remain > 0L) {
         ((Buffer)skipByteBuffer).position(0);
         ((Buffer)skipByteBuffer).limit((int)Math.min(remain, 8192L));
   ...
   public static InputStream toBufferedInputStream(InputStream input) throws IOException {
      return com.dfsek.terra.lib.commons.io.output.ByteArrayOutputStream.toBufferedInputStream(input);
   }

   public static InputStream toBufferedInputStream(InputStream input, int size) throws IOException {
      return com.dfsek.terra.lib.commons.io.output.ByteArrayOutputStream.toBufferedInputStream(input, size);
   }
   ...
   public static byte[] toByteArray(InputStream input, int size) throws IOException {
      return size == 0 ? EMPTY_BYTE_ARRAY : toByteArray(Objects.requireNonNull(input, "input")::read, size);
   }
   ...
   static byte[] toByteArray(IOTriFunction<byte[], Integer, Integer, Integer> input, int size) throws IOException {
      ...
      int read;
      while (offset < size && (read = input.apply(data, offset, size - offset)) != -1) {
         offset += read;
      }
   ...
   public static byte[] toByteArray(Reader reader, Charset charset) throws IOException {
      com.dfsek.terra.lib.commons.io.output.ByteArrayOutputStream output = new com.dfsek.terra.lib.commons.io.output.ByteArrayOutputStream();
   ...
   public static byte[] toByteArray(URL url) throws IOException {
      ...
      byte[] var2;
      try {
         var2 = toByteArray(urlConnection);
      } catch (Throwable var5) {
   ...
   public static String toString(IOSupplier<InputStream> input, Charset charset, IOSupplier<String> defaultString) throws IOException {
      ...
      String var4;
      try {
         var4 = inputStream != null ? toString(inputStream, charset) : defaultString.get();
      } catch (Throwable var7) {
         if (inputStream != null) {
            try {
               inputStream.close();
