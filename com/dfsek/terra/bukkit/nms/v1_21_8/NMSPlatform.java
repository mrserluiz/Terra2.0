...
public class NMSPlatform extends PlatformImpl {
   ...
   public void register(TypeRegistry registry) {
      ...
      registry.registerLoader(PlatformBiome.class, (type, o, loader, depthTracker) -> this.parseBiome((String)o, depthTracker))
         ...
         .registerLoader(Precipitation.class, (type, o, loader, depthTracker) -> Precipitation.valueOf(((String)o).toUpperCase(Locale.ROOT)))
         .registerLoader(GrassColorModifier.class, (type, o, loader, depthTracker) -> GrassColorModifier.valueOf(((String)o).toUpperCase(Locale.ROOT)))
         .registerLoader(GrassColorModifier.class, (type, o, loader, depthTracker) -> TemperatureModifier.valueOf(((String)o).toUpperCase(Locale.ROOT)))
